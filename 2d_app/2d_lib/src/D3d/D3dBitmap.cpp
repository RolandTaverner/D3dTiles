...
namespace TileEngine {
  namespace D3d {
    ...
    bool D3dBitmap::Initialize(ID3D11DevicePtr device, unsigned screenWidth, unsigned screenHeight,
      WCHAR* textureFilename, unsigned bitmapWidth, unsigned bitmapHeight) {
      /*
